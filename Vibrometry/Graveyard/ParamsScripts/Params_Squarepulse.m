...
TestSignal.freqs = [120, 60, 30, 15, 1]; % start frequency
TestSignal.nCycles = [1, 1, 1, 1, 1]; % start frequency
TestSignal.pulseGap = 1; % type of sine sweep ('log' or 'linear')
TestSignal.pulseType = 'Square'; % type of sine sweep ('log' or 'linear')
