...
%%
addpath("Measurements/EM_Measurement_Data")
addpath("COMSOL/EM_COMSOL_Data")

%% Load Measurement Data

load("Measurements/EM_Measurement_Data/LightTouch_PulsedEMData.mat")
...
%% Load COMSOL Data
comsol_data = readmatrix("COMSOL/EM_COMSOL_Data/LightTouch_Unshielded.csv");
